...
from bae_linear import train_bae_linear
from bae_predict import bae_linear_predict
import scipy.sparse as sp
import numpy as np

def run_bae(K, L, X1, X2, train_I, train_J, train_Y, learner, reg_lambda, num_iter,delta_convg, reg_alpha1, reg_alpha2):
    
    if learner.upper() == 'LINEAR':
        params, obj = train_bae_linear(K, L, X1, X2, train_I, train_J, train_Y, reg_lambda, num_iter, delta_convg, reg_alpha1,reg_alpha2)
